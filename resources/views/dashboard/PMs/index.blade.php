...
@section('title')
     Assistants | X Net System - CDD V1.0
            ...
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal"
                        href="#modaldemo8"> Add Assistants </a> @endcan
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                ...
                                <tr>
                                    <th>#</th>
                                    <th>Assistants Operations </th>
                                    <th>Assistants Name </th>
                                    <th>Assistants Email </th>
                                    <th>Assistants Phone</th>
                                </tr>
                            </thead>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title"> Add Assistants </h6><button aria-label="Close" class="close" data-dismiss="modal"
